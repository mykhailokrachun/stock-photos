...
[Stock Photos](https://mykhailok-stock-photos.netlify.app/)
...
- Clone the repository using `git clone https://github.com/mykhailokrachun/stock-photos.git`
- Change directory into the project folder: `cd stock-photos`
- Run `npm install`
- Run `npm start`
